    ...
    <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="d-none d-sm-table-cell">{{$tag->slug}}</td>
          <td class="fw-semibold">
            <a href="{{ route('admin.tags.edit', $tag->id) }}"><i class="fa fa-pencil btn btn-warning"></i></a>
            <a href="">
              <form action="{{ route('admin.tags.destroy', $tag->id) }}" method="POST" role="form" style="display:inline">
                  @csrf
                  @method('DELETE')                   
