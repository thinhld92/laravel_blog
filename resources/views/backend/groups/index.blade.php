      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="fw-semibold">
            <a href="{{ route('admin.groups.edit', $group->id) }}"><i class="fa fa-pencil btn btn-warning"></i></a>
            <a href="">
              <form action="{{ route('admin.groups.destroy', $group->id) }}" method="POST" role="form" style="display:inline">
                  @csrf
                  @method('DELETE')                   
