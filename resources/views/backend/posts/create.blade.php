      ...
      <div class="row push">
        <div class="col-lg-5">
          <div class="mb-2">
            ...
            <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" placeholder="Title Input" value="{{old('title')}}">
            @error('title')
        ...
        <div class="col-lg-5 offset-lg-1">
          <div class="mb-2">
            ...
            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="4" placeholder="Description content..">{{old('description')}}</textarea>
            @error('description')
              <div class="invalid-feedback animated fadeIn">{{$message}}</div>
            @enderror
          </div>
      ...
      <div class="row push">
        <div class="col-lg-5 ">
          <div class="mb-2">
            ...
            <input type="text" class="form-control @error('image_caption') is-invalid @enderror" id="image_caption" name="image_caption" placeholder="Image caption Input" value="{{old('image_caption')}}"> 
            @error('image_caption')
              <div class="invalid-feedback animated fadeIn">{{$message}}</div>
            @enderror          
          </div>
        ...
        <div class="col-lg-5 offset-lg-1">
          <div class="mb-2">
            ...
            <input type="text" class="form-control @error('source') is-invalid @enderror" id="source" name="source" placeholder="Source caption Input" value="{{old('source')}}"> 
            @error('source')
              <div class="invalid-feedback animated fadeIn">{{$message}}</div>
            @enderror          
          </div>
        ...
        <div class="col-lg-5 offset-lg-1">
          <div class="mb-2">
            ...
            <div class="space-x-2">
              ...
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" id="status_inactive" name="status" value="0" {{old('status') === '0' ? 'checked' : ''}}>
      ...
      <div class="row push">
        <div class="col-lg-5 ">
          <div class="mb-2">
            ...
            <input type="text" class="js-flatpickr form-control @error('hot_date') is-invalid @enderror" id="hot_date" name="hot_date" placeholder="Y-m-d" value="{{old('hot_date')}}">
            @error('hot_date')
              <div class="invalid-feedback animated fadeIn">{{$message}}</div>
            @enderror
          </div>
        ...
        <div class="col-lg-5 offset-lg-1">
          <div class="mb-2">
            ...
            <input type="text" class="js-flatpickr form-control @error('new_date') is-invalid @enderror" id="new_date" name="new_date" placeholder="Y-m-d" value="{{old('new_date')}}">
            @error('new_date')
              <div class="invalid-feedback animated fadeIn">{{$message}}</div>
            @enderror
          </div>
      ...
      <div class="row push">
        <div class="col-lg-5 ">
          <div class="mb-2">
            ...
            <input type="text" class="js-flatpickr form-control @error('published_at') is-invalid @enderror" id="published_at" name="published_at" placeholder="Y-m-d" value="{{old('published_at')}}">
            @error('published_at')
              <div class="invalid-feedback animated fadeIn">{{$message}}</div>
            @enderror
          </div>
