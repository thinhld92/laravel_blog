  ...
  <div class="block-content">
    <form action="{{route('admin.users.store')}}" method="POST" enctype="multipart/form-data" >
      ...
      <div class="row push">
        ...
        <div class="col-lg-5 offset-lg-1">
          <div class="mb-2">
            ...
            <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" placeholder="Username Input" value="{{old('username')}}">
            @error('username')
              <div class="invalid-feedback animated fadeIn">{{$message}}</div>
            @enderror
          </div>
      ...
      <div class="row push">
        <div class="col-lg-5 ">
          <div class="mb-2">
            ...
            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="Emai Input" value="{{old('email')}}"> 
            @error('email')
              <div class="invalid-feedback animated fadeIn">{{$message}}</div>
            @enderror          
          </div>
      ...
      <div class="row push">
        <div class="col-lg-5 ">
          <div class="mb-2">
            <label class="form-label" for="group_id">{{ __('custom.attributes.group_id') }} <span class="text-danger">*</span></label>
        ...
        <div class="col-lg-5 offset-lg-1">
          <div class="mb-4">
            ...
            <textarea class="form-control" id="profile_description" name="profile_description" rows="4" placeholder="{{ __('custom.attributes.profile_description') }} content..">{{old('profile_description')}}</textarea>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-5">
          <div class="mb-2">
            ...
            <div class="input-group">
              ...
              <input id="thumbnail" class="form-control {{$errors->has('avatar') ? 'is-invalid' : ''}}" type="text" name="avatar">
            </div>
