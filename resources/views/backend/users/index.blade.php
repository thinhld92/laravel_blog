    ...
    <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
      <thead>
        <tr>
          ...
          <th class="d-none d-sm-table-cell" style="width: 30%;">Profile Description</th>
          <th class="d-none d-sm-table-cell" style="width: 15%;">Avatar</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="d-none d-sm-table-cell">{{$user->profile_description}}</td>
          <td class="d-none d-sm-table-cell">
            <img class="img-avatar img-avatar128 img-avatar-thumb" src="{{$user->avatar}}" alt="">
          </td>
          <td class="fw-semibold">
            <a href="{{ route('admin.users.edit', $user->id) }}"><i class="fa fa-pencil btn btn-warning"></i></a>
            <a href="">
              <form action="{{ route('admin.users.destroy', $user->id) }}" method="POST" role="form" style="display:inline">
                  @csrf
                  @method('DELETE')                   
